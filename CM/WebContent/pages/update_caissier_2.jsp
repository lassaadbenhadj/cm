...
if(userid==null) {
	...
	try  {
		String Sqlstr="SELECT * FROM cm_caisses ";
	    rs=statement.executeQuery(Sqlstr);

%>
<form name="formuc" method="post" action="commit_update2_caissier.jsp" onReset="window.location='main.jsp';">
  ...
  <table width="372" border="0" align="center">
    ...
    <tr>
      <td><input type="hidden" name="caissiersent" value=<% out.println(userid);%>></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
      <div align="center"> <input type="submit" name="Submit" value="Ok    "> </div></td>
