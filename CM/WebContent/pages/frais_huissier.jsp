...
%>
<title>Remboursement à problème</title>
...
<body>
<form name="form1" method="post" action="commit_huissier.jsp" onReset="window.location='main.jsp';">
  <label></label>
  <label><br>
  </label>
  <table width="372" border="0" align="center">
    <tr>
      <th colspan="2" scope="col">Frais Huissier Notaire</th>
    </tr>
    <tr>
      <th scope="col">&nbsp;</th>
      <th scope="col">&nbsp;</th>
    ...
    <tr>
      ...
      <th scope="col"><div align="left">
        <input type="hidden" name="typesent" value=29>
      </div></th>
    </tr>
    <tr>
