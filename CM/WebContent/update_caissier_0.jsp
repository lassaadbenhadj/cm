...
%>
<form name="formcc" method="post" action="commit_update2_caissier.jsp" onReset="window.location='admin_page.jsp';">
  ...
  <table width="372" border="0" align="center">
    ...
    <tr>
      ...
      <div align="center"> <input type="submit" name="Submit" value="Transférer"> </div></td>
